...
void vCommontask_StartApk(void )
{
   ...
   xReturned = xTaskCreate(vSlaveswd_Task,"SLAVE",500U ,NULL,(tskIDLE_PRIORITY+4U), &swSlave_TaskHandle );
   ...
   xReturned = xTaskCreate(vMasterswd_Task,"MASTER",500U ,NULL,(tskIDLE_PRIORITY+4U), &swMaster_TaskHandle );
